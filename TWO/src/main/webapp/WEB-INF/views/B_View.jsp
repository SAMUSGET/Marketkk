...
<body>
 ...
 <button class="site-btn" style="width: 115px; height: 53px;"onclick="location.href='B_modiForm?BNo=${view.BNo}&page=${page}&MId=${sessionScope.loginId}'">글 수정</button>
                         
						  <c:if test="${view.BWriter eq sessionScope.loginId}">
  <button class="site-btn" style="width: 115px; height: 53px;"onclick="location.href='B_delete?BNo=${view.BNo}&page=${page}'">글 삭제</button>                        
  </c:if>
   <c:if test="${sessionScope.loginId eq 'admin'}">
	...
	<div class="cmt_write_box">
		...
		<div class="cmt_txt_cont">
			<div class="cmt_write">
			<textarea rows="5" cols="132" placeholder="댓글을 입력해주세요." id="CContent"></textarea>
