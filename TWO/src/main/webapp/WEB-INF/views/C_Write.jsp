                        ...
                        <div class="col-lg-8 col-md-6">
                            ...
                            <div class="checkout__input">
                            	<p>게시글 종류<span>*</span></p>
                            		<label><input type="radio" name="#" value="0" onclick="div_OnOff(this.value,'con');"> 일반글</label>
      								<label><input type="radio" name="#" value="1" onclick="div_OnOff(this.value,'con');"> 거래글</label>
                            </div>
